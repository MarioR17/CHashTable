...
int main(void) {
    ...
    unsigned int idxOne = getIndex(ht, keyOne);
    unsigned int idxTwo = getIndex(ht, keyTwo);
    unsigned int idxThree = getIndex(ht, keyThree);
    unsigned int idxFour = getIndex(ht, keyFour);
    unsigned int idxFive = getIndex(ht, keyFive);
